...
alias format='clang-format -style="{BasedOnStyle: LLVM, IndentWidth: 4, ColumnLimit: 120, AllowShortFunctionsOnASingleLine: Empty, AllowShortLoopsOnASingleLine: false}" -i'
